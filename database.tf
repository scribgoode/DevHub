...
resource "aws_db_subnet_group" "default" {
  ...
  tags = {
    Name = "ProjectPals_EC2_Subnet_Group"
  }
}
...
resource "aws_security_group" "rds_sg" {
  ...
  name        = "ProjectPalsRDSSecurityGroup"
  ...
  tags = {
    Name = "ProjectPals_RDS_Security_Group"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  identifier             = "my-projectpals-rds"
  db_name                = "projectpalsdb"
  username               = "projectpalsuser"
